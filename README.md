...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/swamivikas/AJAX-Movie-Recommendation-System-with-Sentiment-Analysis-master/blob/main/requirements.txt) file with the command `pip install -r requirements.txt`
